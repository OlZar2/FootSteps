...
using FS.API.Controllers.FindAnnouncement.RequestModels;
using FS.API.Errors;
...
namespace FS.API.Controllers.FindAnnouncement.Controllers;
    ...
    IGeocoder geocoder) : ControllerBase
{
    ...
    public async Task<FindAnnouncementFeed[]> GetFeed(
        ...
        CancellationToken ct)
    {
        ...
        var feed = await findAnnouncementService.GetFeedAsync(
            filter,
            lastDateTime,
            ct);
