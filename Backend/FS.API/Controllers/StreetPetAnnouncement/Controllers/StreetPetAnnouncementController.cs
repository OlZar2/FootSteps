...
using FS.API.Controllers.StreetPetAnnouncement.RequestModels;
using FS.API.Errors;
...
namespace FS.API.Controllers.StreetPetAnnouncement.Controllers;
...
public class StreetPetAnnouncementController(
    ...
    IValidator<StreetPetAnnouncementFilter> streetPetAnnouncementFilterValidator,
    ...
    IGeocoder geocoder) : ControllerBase
{
    ...
    {
        await streetPetAnnouncementFilterValidator.ValidateAndThrowAsync(filter, ct);
        
        var response = await streetPetAnnouncementService.GetFeedAsync(
            filter,
            lastDateTime,
            ct);
        return response;
