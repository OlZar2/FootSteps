...
namespace FS.Migrations.Migrations
{
    ...
    [Migration("20251204092816_DDDRefactorMigration")]
    partial class DDDRefactorMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FS.Core.AnimalAnnouncementBC.Entites.Image", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FS.Core.UserDomain.User", b =>
                {
                    b.HasOne("FS.Core.AnimalAnnouncementBC.Entites.Image", null)
                        .WithOne()
